    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 z-10 text-center">
          <h1 className="text-4xl md:text-6xl font-bold text-primary-foreground mb-6 animate-in fade-in slide-in-from-bottom duration-700">
            SpurMount Trading & Investment
          </h1>
          <p className="text-xl md:text-2xl text-primary-foreground/90 mb-4 animate-in fade-in slide-in-from-bottom duration-700 delay-100">
            Eat Quality, Live Quality
          </p>
          <p className="text-lg text-primary-foreground/80 mb-8 max-w-2xl mx-auto animate-in fade-in slide-in-from-bottom duration-700 delay-200">
      ...
      <section className="py-16 gradient-subtle">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12 text-foreground">Why Choose SpurMount?</h2>
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <Card key={index} className="shadow-card hover:shadow-elevated transition-smooth border-border/50">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-4 text-foreground">Our Product Categories</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {categories.map((category, index) => (
              <Card 
                key={index} 
                className="shadow-card hover:shadow-elevated transition-smooth cursor-pointer group border-border/50"
              >
